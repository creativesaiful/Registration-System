...
<body>
    ...
    <p>Thank you for your registration. Your registered email address is <strong> {{$details['email']}} </strong>  and phone number <strong>{{$details['phone']}}</strong> </p>
</body>
</html> --}}
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td style="padding-bottom:20px;">
                      ...
                      <br>
                      Thank you for your registration. Your registered email address is <strong> {{$details['email']}} </strong>  and phone number <strong>{{$details['phone']}}</strong> <br>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td class="left" style="text-align:left;">
                      Thanks so much for your registration.
                    </td>
                  </tr>
